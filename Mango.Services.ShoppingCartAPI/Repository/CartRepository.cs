...
namespace Mango.Services.ShoppingCartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<bool> ClearCart(string userId)
        {
            ...
            {
                _db.CartDetails.RemoveRange(_db.CartDetails.Where(c => c.CartHeaderId == cartHeaderFromDb.CartHeaderId));
        ...
        public async Task<CartDto> CreateUpdateCart(CartDto cartDto)
        {
            ...
            // check if product has in database, then don't create it 
            var prodInDb = await _db.Products.AsNoTracking()
                .FirstOrDefaultAsync(u => u.Id == cartDto.CartDetails.FirstOrDefault().ProductId);
        ...
        public async Task<bool> RemoveFromCart(int cartDetailsId)
        {
            try
            {
                ...
                int totalCountOfCartItems = await _db.CartDetails.CountAsync(c => c.CartHeaderId == cartDetails.CartHeaderId);
